...
const AdminLogin = () => {
  ...
  const getAccess = () => {
    if(email==="") window.alert("Enter admin's credencials")
    if (email === "admin@gmail.com" && password === "admin") {
      window.alert("Login Successful");
      history.push("/aAbBcC");
    } else if (email === "portaledu7817@gmail.com" && password === "@education123") {
      window.alert("Login Successful");
  ...
  return (
    <>
      ...
      <form method="GET">
        <div className="form-group text-center jumbotron mx-7" style={{width:"80vh" }}>
          <div>
