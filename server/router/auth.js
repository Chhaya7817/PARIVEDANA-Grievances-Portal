...
router.post("/register",async(req,res)=>{
    ...
    if(name==="a" || !email || !phone || !address || !password|| !cpassword){
    ...
    try{
        ...
        if(userExist){
          ...
          if(userRegister){
            const message={
              // to:`${email}`,
              to:"2000chhayachaudhary@gmail.com",
              from: 'portaledu7817@gmail.com',
            ...
            res.status(200).json({message:"Registration Successful done"})
          }else{
